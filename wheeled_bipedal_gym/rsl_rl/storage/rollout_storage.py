...
from wheeled_bipedal_gym.rsl_rl.utils import split_and_pad_trajectories
...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, privileged_obs_shape, obs_history_shape, actions_shape, cost_shape, cost_d_values, device='cpu'):
